PRO report, nstar3d=nstar3d, nplanet3d=nplanet3d
  ...
  filen = '../Sims/ss_13x26.sav' 
  frac_file = '../ExpTimeCalc/frac26'+psfstr+'.fits' 
  fov = 26.0
  seg = 13
  ...
  fname = '../Report/rep_2p5_'+strtrim(seg,2)+'x'+strtrim(round(fov),2)+'_'+strtrim(round(geomarea),2)+psfstr
