PRO fits2sav_wrapper, fstub
  ...
  for ii=0, numfil-1 do begin
    ...
    if (strmatch(fstub, '*dp*')) then fits2sav, fnames[ii], ss, tt, nstar=nstar, kmin=15., dartcor=1, jlfr=lfr
    if (strmatch(fstub, '*bk*')) then fits2sav, fnames[ii], ss, tt, nstar=nstar, tmin=21., dartcor=1, jlfr=lfr
  end
END
